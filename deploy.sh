...
scp -i "$SSH_KEY" scripts/init-auth-users.sql scripts/init-chat-sessions.sql scripts/init-draft-assistant.sql scripts/init-report-plans.sql "$REMOTE_USER@$REMOTE_HOST:$SRC_DIR/scripts/"
