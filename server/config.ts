...
export const REPORT_TIMEOUT_MS = Number(process.env.HERMES_TIMEOUT_MS || 1500000);
export const HERMES_DEEP_SOURCE_COLLECTION_TIMEOUT_MS = Number(
  process.env.HERMES_DEEP_SOURCE_COLLECTION_TIMEOUT_MS || 1500000,
);
export const HERMES_RUNS_RECOVERY_WAIT_MS = Number(process.env.HERMES_RUNS_RECOVERY_WAIT_MS || 300000);
