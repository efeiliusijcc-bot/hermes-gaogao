...
export class HermesService {
  ...
  private getSkillRequirements(input: RunInput): string[] {
    ...
    return [
      ...
      '21. The internal reference artifact JSON schema is: {"jobId":"...","referenceGuardVersion":2,"updatedAt":"ISO time","sourceCount":N,"references":[{"citationNo":1,"title":"","sourceName":"","url":"","publishedAt":"","summary":"","excerpt":"","rawReferenceText":"[1] ...","sourceType":"report_reference","relevanceScore":100,"status":"referenced","method":"final_report_reference_index","matchStatus":"matched|raw_only"}]}.',
